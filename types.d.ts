...
declare module 'mouse-position' {
  function attach(HTMLCanvasElement) : [number, number, number];
  export default attach;
}        

declare module 'mouse-pressed' {
  function pressed(HTMLCanvasElement) : boolean;
